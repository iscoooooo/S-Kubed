...
subplot(3,2,2)
plot(xStepArray,xErrorArray,'LineWidth',1,'Color',"#7E2F8E")
title('Error for X')
...
subplot(3,2,4)
plot(yStepArray,yErrorArray,'LineWidth',1,'Color',"#7E2F8E")
title('Error for Y')
...
subplot(3,2,6)
plot(zStepArray,zErrorArray,'LineWidth',1,'Color',"#7E2F8E")
title('Error for Z')
